#![no_std] // This is a no_std contract, so we don't use the standard library.

use soroban_sdk::{contract, contractimpl, Address,Env,token,IntoVal};
...
fn move_token( //it will help us activate the arguments below
    env:&Env,
    token:&Address,
    from:&Address,
    to:&Address,
